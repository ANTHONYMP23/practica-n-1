package com.example.application.views.formulariodedireccióndelcliente;
...
@PageTitle("Formulario de dirección del cliente . ")
@Route(value = "address-form", layout = MainLayout.class)
public class FormulariodedireccióndelclienteView extends Div {
    ...
    public FormulariodedireccióndelclienteView(SampleAddressService addressService) {
        addClassName("formulariodedireccióndelcliente-view");
